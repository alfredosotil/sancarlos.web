                  ...
                  <div class="form-panel">
                      ...
                      <form class="form-horizontal style-form" method="get">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input type="text" class="form-control round-form" placeholder="DD/MM/AAAA">
                              </div>
                          </div>
                           ...
                           <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input class="form-control" id="focusedInput" type="text" value="Brindamos servicio de consultoria en la elaboración de Expediententes Tecnicos para licitaciones públicas y privadas...">
                              </div>
                          </div>
