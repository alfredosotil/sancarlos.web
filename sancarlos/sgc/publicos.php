      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> Proyectos Públicos</h3>
				<div class="row">
                  ...
                  <div class="col-md-12">
                      <div class="content-panel">
                          <table class="table table-striped table-advance table-hover">
	                  	  	  <h4><i class="fa fa-angle-right"></i> Nuevo Proyecto:  &nbsp;&nbsp;<a href="new_proyecto.php"><button type="button" class="btn btn-theme">+ Agregar</button></a></h4>
	                  	  	  <hr>
                        </table>
                      </div><!-- /content-panel -->
                  </div><!-- /col-md-12 -->
                      ...
                      <div class="content-panel">
                          <table class="table table-striped table-advance table-hover">
                              ...
                              <tr>
                                  ...
                                  <th class="hidden-phone"><i class="fa fa-question-circle"></i> Categoría</th>
                              ...
                              <tr>
                                  ...
                                  <td class="hidden-phone">Educativas</td>
                                  <td>
                              ...
                              <tr>
                                  ...
                                  <td class="hidden-phone">Salud</td>
                                  <td>
                                      <button class="btn btn-success btn-xs"><i class="fa fa-eye"></i></button>
                                      </td>
                              ...
                              <tr>
                                  ...
                                  <td class="hidden-phone">saneamiento</td>
                                  <td>
                                      <button class="btn btn-success btn-xs"><i class="fa fa-eye"></i></button>
                                  </td>
                                  <td><span class="label label-success label-mini">Activo</span></td>
                              ...
                              <tr>
                                  ...
                                  <td class="hidden-phone">Viales</td>
                                  <td>
                                      <button class="btn btn-success btn-xs"><i class="fa fa-eye"></i></button>
                                  </td>
                                  <td><span class="label label-success label-mini">Activo</span></td>
                              ...
                              <tr>
                                  ...
                                  <td class="hidden-phone">Institucionales</td>
                                  <td>
                                      <button class="btn btn-success btn-xs"><i class="fa fa-eye"></i></button>
                                  </td>
                                  <td><span class="label label-danger label-mini">Inactivo</span></td>
