          ...
          <section class="wrapper">
          	...
          	<div class="row mt">
                  ...
                  <div class="form-panel">
                      ...
                      <form enctype="multipart/form-data" action="<?php echo site_url('sgc/InsertarEquipo');?>" class="form-horizontal style-form"  id="insertarEquipo_form" name="insertarEquipo_form" method="POST">
                          ...
                          <div class="form-group">
                           ...
                           <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  	 <input type="file" class="btn btn-theme" accept="application/pdf" name="file0" required="required">
                              </div>
                          </div>
